...
class AbsoluteHearingMode(Game):
    ...
    def __init__(self):
        ...
        ----------
        arr : array
            Array of only relevant note from json
        noteamount : int
            The length of the notes array.
        data : array
            Array of all the notes from json.
        """
    ...
    def generate_random_note(self):
        ...
        Return the index of the arr in the generate number.
        Parameters
        ----------
        current_note : array
            The generate note.
        randnum : int
            Random number in range 0,noteamount-1 (length of arr)
        """
    ...
    def note_compare(self):
        ...
        ----------
        detected_note : array
            The note selected by the user.
        current_note : array
            The note generated by the program.
        """
